...
import {FiAward,FiX,FiExternalLink,FiZoomIn,FiChevronLeft,FiChevronRight,FiAlertCircle,FiRefreshCw} from 'react-icons/fi'
import './Certificates.css'

const BUCKET='Portfolio',FOLDER='certificates_image',SLIDE_AT=3
...
export default function Certificates(){
  ...
  useEffect(()=>{
    const ch=supabase.channel('certificate-changes')
      .on('postgres_changes',{event:'*',schema:'public',table:'certificate'},()=>fetchCerts().then(setCerts).catch(console.error))
      .subscribe()
            ...
            <div className="cert-lb-info">
              ...
              {preview.verification_url&&(
                <a href={preview.verification_url} target="_blank" rel="noopener noreferrer"
                   className="btn-primary" style={{width:'fit-content',marginTop:10}}>
