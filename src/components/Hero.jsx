...
import { FiGithub, FiLinkedin, FiMail, FiArrowDown, FiInstagram, FiMapPin } from 'react-icons/fi'
      ...
      <div className="container hero-container">
        ...
        <div className="hero-img-wrap fade-in delay-3">
          <div className="hero-img-card">
            ...
            <div className="hero-badge-float badge-1"><span />🎓Engineering Student</div>
            <div className="hero-badge-float badge-2"><span />💻Developer & Designer</div>
          </div>
